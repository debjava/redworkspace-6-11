...
public class MyDTDGenerator extends org.xml.sax.helpers.DefaultHandler {
...
//        } 
    	...
    	String filePath = "data/org.xml";
        MyDTDGenerator app = new MyDTDGenerator();

        app.run(filePath);
        app.printDTD();
        
        System.out.println("------------------------------------------------");
        System.out.println(app.builder);
        System.out.println("------------------------------------------------");
    }
    ...
    private void printDTD ()
    {
        ...
        while ( e.hasNext() )
        {
            ...
            if (childKeys.size()==0 && !ed.hasCharacterContent)
            {
            	...
            	builder.append("<!ELEMENT " + elementname + " EMPTY >\n");
            ...
            if (childKeys.size()==0 && ed.hasCharacterContent)
            {
            	...
            	builder.append("<!ELEMENT " + elementname + " ( #PCDATA ) >\n");
            }

            //ELEMENT content
            if (childKeys.size()>0 && !ed.hasCharacterContent) {
                System.out.print("<!ELEMENT " + elementname + " ( ");
                builder.append("<!ELEMENT " + elementname + " ( ");
                if (ed.sequenced) {
            ...
            while ( a.hasNext() )
            {
                ...
                builder.append("<!ATTLIST " + elementname + " " + attname + " ");
                ...
                if (isid) { 
                    ...
                    builder.append(tokentype + " #FIXED \"" + escape(val) + "\" >\n");
                }
                else if (isenum) {
                    System.out.print("( ");
                    builder.append("( ");
