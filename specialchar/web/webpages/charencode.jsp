    ...
    <fieldset style="width: 600px;height:200;">
        ...
        <table>
            <tr> 
              <td>Text data:</td>
              <td>
                <textarea rows="4" cols="35" name="?" id="textDataId" name="inputtextarea"></textarea>
              </td>
            </tr>
            <tr>
                <td/>
...
<!--                    <input type="button" name="jssubmit" value="Javascript Submit" onclick="populate();"/>-->
                    <input type="button" name="ajaxsubmit" value="Submit" />
                </td>
            </tr>
        </table>
    </fieldset>
    ...
    <fieldset style="width: 600px;height:200;">
        ...
        <table>
            <tr> 
              <td>Text data:</td>
              <td>
                <textarea rows="4" cols="35" name="?" id="displayTextDataId" name="displaytextarea"></textarea>
              </td>
            </tr>
        </table>
    </fieldset>
